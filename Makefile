...
test: s21_string.a
	gcc $(CFLAGS) -o test test.c -I/opt/homebrew/Cellar/check/0.15.2/include -L/opt/homebrew/Cellar/check/0.15.2/lib s21_string.a $(LFLAGS)
	@./test
...
gcov_report: test
	...
	gcc -fprofile-arcs -ftest-coverage -g -o test test.c -I/opt/homebrew/Cellar/check/0.15.2/include -L/opt/homebrew/Cellar/check/0.15.2/lib s21_string.o s21_sprintf.o $(LFLAGS)
	@./test
	mkdir gcov_report
